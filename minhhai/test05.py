...
test_driver.find_element(By.XPATH, '//*[@id="txtSearch"]').send_keys('đế vương')

# Step 7: Bấm vào button  "tìm kiếm"
test_driver.find_element(By.XPATH, '//*[@id="btnSearch"]').click()

# Step 8: Bấm vào để phát nhạc
test_driver.find_element(By.XPATH, '/html/body/div[3]/div/div/div[1]/div[6]/ul[1]/li[1]/a/img').click()
